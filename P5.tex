...
\begin{document}
	...
	\begin{proof}
		...
		\begin{align*}
			...
			\bigcup_{S \in \calL^*_{\max}} w(F_S) &\leqslant 2\rho \left(1 - \delta\right) \val(\calI)  \hspace*{2cm} -  \text{ As all $S$ are disjoint and, \hyperref[def:6:q-bb]{from \ref{def:6:q-bb}} as $B$ was a quasi-backbone.}
		\end{align*}
		\begin{align*}
