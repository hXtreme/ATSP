...
\begin{document}
  ...
  \end{tikzpicture}
    \caption{The figure on the left shows a tour $T$ in instance $\calI[S]$. The figure on the right shows the subtour $F_i$ constructed by using $T$. Here the solid edges represent the egdes from $T$ and the dashed edges represent the shortest $u_{out} - v_{in}$ paths mentioned in the definition.}
  \end{figure}
\end{document}