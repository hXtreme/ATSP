...
\begin{document}
  ...
  \begin{tikzpicture}
    ...
    \draw[->-, dash pattern={on 3.0pt off 3.0pt}] (v1) .. controls (1, -2.5) and (-1, -2.5) .. (u2);
    \draw[->-] (u2) -- (v2);
    \draw[->-, dash pattern={on 3.0pt off 3.0pt}] (v2) .. controls (1, -3.3) and (-1, -3.3) .. (u3);
    \draw[->-] (u3) .. controls (0, -3.8) .. (v3);
    \draw[->-, dash pattern={on 3.0pt off 3.0pt}] (v3) .. controls (0, -2.5) .. (u1);
